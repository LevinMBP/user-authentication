...
SECRET_KEY = 'django-insecure-x-gz%*g+fgn5uv&(x1v^4g$enilk!r_d*q#!-1=9-+l7=wyuk8'
...
EMAIL_HOST_USER = 'lolideppt@gmail.com'
EMAIL_USE_TLS = True
# DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL')
DEFAULT_FROM_EMAIL = 'lolideppt@gmail.com'
EMAIL_PORT = 587
# EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD')
EMAIL_HOST_PASSWORD = 'ddaqxxerzhcjzqlp'